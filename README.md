...
Documentation: [Release notes 1.3.0](docs/RELEASE_NOTES_1.3.0.md) | [Controls guide](docs/CONTROLS.md) | [Electronic warfare](docs/ELECTRONIC_WARFARE.md)
...
- WarTech Reforged `1.3.0-hbm5751`
...
3. Remove the original WarTech JAR and all older WarTech Reforged builds from
   the `mods` folder.
4. Place `WarTech-Reforged-1.3.0-hbm5751.jar` in the `mods` folder.
...
Документация: [Описание версии 1.3.0](docs/RELEASE_NOTES_1.3.0.md) | [Полное управление](docs/CONTROLS.md) | [Радиоэлектронная борьба](docs/ELECTRONIC_WARFARE.md)
...
4. Поместите `WarTech-Reforged-1.3.0-hbm5751.jar` в папку `mods`.
