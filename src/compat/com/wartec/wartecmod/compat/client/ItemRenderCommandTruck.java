...
public final class ItemRenderCommandTruck implements IItemRenderer {
    private final RenderCommandTruck renderer;

    public ItemRenderCommandTruck(RenderCommandTruck renderer) {
